                ...
                <View style={cardStyle}>
                    ...
                    <View style={imageContainer}>
                        <ScrollView style={{ flexDirection: 'row', padding: 10, height: swiperHeight }} horizontal >
                            <Image source={{ uri: `${url}${product.images[0].replace('.jpeg', '.jpg')}` }} style={productImageStyle} />
                            <Image source={{ uri: `${url}${product.images[1].replace('.jpeg', '.jpg')}` }} style={productImageStyle} />
                        </ScrollView>
                    </View>
                    <View style={footer}>
